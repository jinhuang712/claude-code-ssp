...
It starts `claude-code-ssp serve` on 127.0.0.1:4877 if it is not already running and opens the browser on this
session's preview (it passes `$CLAUDE_CODE_SESSION_ID`).
