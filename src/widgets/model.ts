...
export const modelBadge = defineWidget<{
  ...
  schema: {
    ...
    properties: {
      ...
      effortStyle: { type: "string", enum: ["symbol-word", "word", "symbol"], default: "symbol-word", title: "Effort style", "x-requires": { showEffort: true } },
      effortParens: { type: "boolean", default: false, title: "Effort in parentheses", "x-requires": { showEffort: true } },
